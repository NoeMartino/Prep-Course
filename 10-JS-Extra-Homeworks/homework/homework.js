...
function asAmirror(str) {
  ...
  let strAsMirror = arreglo.map(function(elemento){
    return elemento.split("").reverse().join("")
  })
  return strAsMirror.join(" ")
}
...
function capicua(numero){
  ...
  let numb = num.split("").reverse().join("")
  if(numero == numb){
    return "Es capicua"
...
/*function encontrarLaPalabraMasLarga(arr) {
  //La función recibe una matriz de strings. Encuentra la string más larga del array y devuélvela
  //Escribe tu código aquí
  let palabraMasLarga = arr[0];
